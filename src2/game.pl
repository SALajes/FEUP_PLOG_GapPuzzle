...
define_cardinality(Row, Dimension, Aux, Cardinality):-
    append(Aux, [Row-2], Aux2),
    Row2 is Row + 1,
    define_cardinality(Row2, Dimension, Aux2, Cardinality).
...
%---------OPTIONS----------
option(1, Variables, Cardinality, Dimension, Restrictions):-
    Size is Dimension*2,
    length(Variables, Size),
    End is Dimension + 1,
    define_cardinality(1, End, [], Cardinality),
    ask_restrictions(Dimension, Restrictions).

option(2, Variables, Cardinality, Dimension, Restrictions):-
    Size is Dimension*2,
    length(Variables, Size),
    End is Dimension + 1,
    define_cardinality(1, End, [], Cardinality),
